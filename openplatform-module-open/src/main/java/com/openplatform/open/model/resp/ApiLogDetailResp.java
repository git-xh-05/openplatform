...
@Data
@Schema(description = "调用日志详情响应参数")
public class ApiLogDetailResp implements Serializable {
    ...
    @Schema(description = "请求参数", example = "{\"page\":1}")
    private String requestParams;

    @Schema(description = "响应体", example = "{\"data\":[]}")
