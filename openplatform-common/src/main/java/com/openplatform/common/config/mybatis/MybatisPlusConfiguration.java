...
package com.openplatform.common.config.mybatis;
...
public class MybatisPlusConfiguration {
     ...
     * 枚举类型处理器配置
     * <p>
     * 注册 ContiNew Starter 的 {@link CompositeBaseEnumTypeHandler}，使实现
     * {@link top.continew.starter.core.enums.BaseEnum} 的枚举（如 DisEnableStatusEnum）
     * 可以按 value 与数据库中的数字值相互映射，而不是按枚举名匹配。
     * （ContiNew Starter 的自动配置默认启用条件为 mybatis-plus.extension.enabled，
     * 本配置未启用该条件，因此在此手动注册）
     */
    @Bean
